...
;case WM_DESTROY :
	...
	cmp dword ptr ss:[ebp-60],0Fh
		ja mdidemo.401977
		je mdidemo.4017F5
	cmp dword ptr ss:[ebp-60],1 ;WM_CREATE
		je mdidemo.4016FF
	cmp dword ptr ss:[ebp-60],2 ;WM_DESTROY
		je mdidemo.401920
		jmp mdidemo.4019B5
	cmp dword ptr ss:[ebp-60],111h
		ja mdidemo.4019A3
		je mdidemo.40175D
	cmp dword ptr ss:[ebp-60],10h
		jb mdidemo.4019B5
	cmp dword ptr ss:[ebp-60],11h
		jbe mdidemo.4018F5
		jmp mdidemo.4019B5
	cmp dword ptr ss:[ebp-60],222h
		je mdidemo.401860
