...
;================================================================================================
WinMain proc uses ebx esi edi, hInstance:QWORD,hPrevInstance:QWORD,szCmdLine:QWORD,iCmdShow:QWORD
;================================================================================================
	LOCAL hAccel:DWORD
	LOCAL hwndFrame:DWORD, hwndClient:DWORD
	LOCAL MSG32:msg
	LOCAL WNDCLASSEX32:wc
...
MsgLoop:
	invoke GetMessageA, offset msg,0,0,0
		...
		cmp eax,0
		jne MsgLoop
	invoke TranslateAccelerator, hwndFrame, hAccel, offset msg
		cmp eax,0
		jne MsgLoop
...
;=====================================================================================
FrameWndProc uses ebx esi edi, proc hWnd:DWORD, uMsg:DWORD, wParam:DWORD, lParam:DWORD
;=====================================================================================
...
wmFrameCreate:
	...
	invoke CreateWindowExA,0,offset szClientClass,0,\
        	...
        	80000000h,80000000h,80000000h,80000000h,\ ;CW_USEDEFAULT
        	hwnd,1,hInstance,offset clientcreate
		mov hwndClient,eax
		jmp finFrameWndProc
...
;==========================================================
CloseEnumProc uses ebx esi edi proc hWnd:DWORD,lParam:DWORD
;==========================================================
	;GW_OWNER = 4
...
;=================================================================================
HelloWndProc uses ebx esi edi proc hWnd:DWORD,iMsg:DWORD,wParam:DWORD,lParam:DWORD
;=================================================================================
