...
szLogObjOpened  db "File opened, size: ",0
...
szErrLoadObjOpen db "LoadOBJ: Cannot open file",0
szErrLoadObjFileSize db "LoadOBJ: File size error",0
szErrLoadObjMap db "LoadOBJ: Mapping failed",0
