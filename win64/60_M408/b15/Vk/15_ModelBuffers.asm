...
mov eax,stagingVertexMemReqs_memoryTypeBits ;Why not RCX?!
call FindHostVisibleMemoryType
cmp eax,-1
je lbl_createModelBuffers_VkError

;Verify index < memoryTypeCount
mov ecx,modelMemProps_memoryTypeCount
cmp eax,ecx
...
mov stagingVertexAllocInfo_memoryTypeIndex,eax ;Received from FindHostVisibleMemoryType
...
mov eax,deviceVertexMemReqs_memoryTypeBits ;Why not RCX?!
...
mov deviceVertexAllocInfo_memoryTypeIndex,eax ;Received from FindDeviceLocalMemoryType
...
mov eax,stagingIndexMemReqs_memoryTypeBits ;Why not RCX?!
call FindHostVisibleMemoryType
cmp eax,-1
je lbl_createModelBuffers_VkError
...
mov stagingIndexAllocInfo_memoryTypeIndex,eax ;Received from FindHostVisibleMemoryType
...
;WHY FINDING IT AGAIN?
;WHY NOT STORING THE FOUND INDEX IN A GLOBAL VARIABLE?
mov eax,deviceIndexMemReqs_memoryTypeBits ;Why not RCX?!
call FindDeviceLocalMemoryType
cmp eax,-1
je lbl_createModelBuffers_VkError
...
mov deviceIndexAllocInfo_memoryTypeIndex,eax ;Received from FindDeviceLocalMemoryType
...
LOCAL memTypeBits:DWORD, neededBits:DWORD
PROLOG 100h

mov memTypeBits,eax
;VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT = 2
;VK_MEMORY_PROPERTY_HOST_COHERENT_BIT = 4
mov neededBits,6 ;2+4 = 6

;We already did it for the Depth Buffer. Why doing it again?
LOG_TEXT szVkGetPhysicalDeviceMemoryProperties
mov rcx,ghVkPhysicalDevice
lea rdx,modelMemProps_memoryTypeCount
...
mov rdx,rcx
shl rdx,3 ;i*8
lea rsi,modelMemProps_memoryTypes
add rsi,rdx
...
inc ecx
cmp ecx,modelMemProps_memoryTypeCount
jl lbl_Loop
