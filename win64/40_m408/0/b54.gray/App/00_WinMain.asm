...
mov r9,16C80000h ;~(WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_SIZEBOX)
mov qword ptr [rsp+20h],10h ;x = 16
mov qword ptr [rsp+28h],10h ;y = 16
mov qword ptr [rsp+30h],500h ;nWidth = 1024
mov qword ptr [rsp+38h],500h ;nHeight = 1024
...
call parseObjFile
call createVkContext

LOG_TEXT szUpdateWindow
mov rcx,ghWndMain
call UpdateWindow
LOG_TEXT szOK
