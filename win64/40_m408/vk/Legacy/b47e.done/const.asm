...
align 10h
gpTestDiffuseColors \
    dd 0.0000, 0.0000, 0.0000, 0.15 ;material 0: Glass (black diffuse)
    dd 0.6500, 0.6500, 0.6500, 1.0 ;material 1: Chrome (white)
    dd 0.1500, 0.2500, 0.6000, 1.0 ;material 2: BlueSpace
    dd 0.7500, 0.2500, 0.0000, 0.9 ;material 3: Lights_Red
    dd 0.8500, 0.8500, 0.8500, 0.9 ;material 4: Lights_Rear_White
    dd 0.2500, 0.2500, 0.2500, 1.0 ;material 5: Rusty
    dd 0.1000, 0.1000, 0.1000, 1.0 ;material 6: Black
