...
materialColorPushConstantRange_size dd 10h ;16 bytes (4 floats: Kd.rgb + alpha)
...
align 10h
colorBlendAttachment_blendEnable dd 1 ;VK_TRUE - enable blending
colorBlendAttachment_srcColorBlendFactor dd 6 ;VK_BLEND_FACTOR_SRC_ALPHA
colorBlendAttachment_dstColorBlendFactor dd 7 ;VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA
...
depthStencil_depthTestEnable dd 1 ;VK_TRUE - keep depth testing
;depthStencil_depthWriteEnable dd 0 ;VK_FALSE - DON'T  write depth for transparent objects
depthStencil_depthWriteEnable dd 1 ;VK_TRUE - write depth for ALL objects
depthStencil_depthCompareOp dd 3 ;VK_COMPARE_OP_LESS_OR_EQUAL = 3
