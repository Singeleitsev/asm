...
szErrObjOpen db "Cannot open OBJ file",0Dh,0Ah,0
szErrObjFileSize db "OBJ file size error",0Dh,0Ah,0
szErrObjMap db "Mapping OBJ failed",0Dh,0Ah,0
...
szLogTotalObjects db "Objects: ",0
szLogTotalGroups db "Groups: ",0
szLogTotalSubGroups db "SubGroups: ",0
szLogTotalVertices db "Vertices: ",0
szLogTotalNormals db "Normals: ",0
szLogTotalTextureVectors db "Texture vectors: ",0
szLogTotalFaces db "Faces: ",0
szLogTotalMtlLibs db "Material Libraries Used: ",0

szParsingObject db "Parsing Object",0Dh,0Ah,0
szLogUniqueObjects db "Unique Objects: ",0
szParsingGroup db "Parsing Group",0Dh,0Ah,0
szLogUniqueGroups db "Unique Groups: ",0
szParsingSubGroup db "Parsing SubGroup (Used Material inside Group)",0Dh,0Ah,0
szLogUniqueSubGroups db "Unique SubGroups: ",0

szParsingVertice db "Parsing Vertice",0Dh,0Ah,0
szLogVerticesParsed db "Parsed Vertices: ",0
szParsingNormal db "Parsing Normal",0Dh,0Ah,0
szLogNormalsParsed db "Parsed Normals: ",0
szParsingTextureVector db "Parsing Texture Vector",0Dh,0Ah,0
szLogTextureVectorsParsed db "Parsed Texture Vectors: ",0

szParsingFaces db "Parsing Faces",0Dh,0Ah,0
szLogFacesParsed db "Parsed Faces: ",0
szParsingIndices db "Parsing Indices",0Dh,0Ah,0
szLogIndicesCount db "Computed Indices: ",0
...
szErrMtlOpen db "Cannot open MTL file",0Dh,0Ah,0
szErrMtlFileSize db "MTL file size error",0Dh,0Ah,0
szErrMtlMap db "Mapping MTL failed",0Dh,0Ah,0
...
szLogTotalMaterials db "Materials: ",0
