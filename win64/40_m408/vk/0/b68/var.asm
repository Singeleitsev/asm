...
gnTotalObjects dd 0
gnTotalGroups dd 0
gnTotalSubGroups dd 0
gnTotalFaces dd 0
gnTotalVertices dd 0
gnTotalNormals dd 0
gnTotalTextureVectors dd 0
gnTotalMtlLibs dd 0

gnUniqueObjects dd 0
gnUniqueGroups dd 0
gnUniqueSubGroups dd 0
gnUniqueMtlLibs dd 0

gnArraySizeObjects dd 0
gnArraySizeGroups dd 0
gnArraySizeSubGroups dd 0
gnArraySizeVertices dd 0
gnArraySizeNormals dd 0
gnArraySizeTextureCoords dd 0
gnArraySizeFaces dd 0
gnArraySizeMtlLibs dd 0
gnArraySizeIndices dd 0

gpDataObjects dq 0
gpDataGroups dq 0
gpDataSubGroups dq 0
gpDataVertices dq 0
gpDataNormals dq 0
gpDataTextureVectors dq 0
gpDataFaces dq 0
gpDataMtlLibs dq 0
gpDataIndices dq 0

;Global Source Pointer for Parsers
gpCurrentSource dq 0
;Destination Pointers for Parsers
gpCurrentObject dq 0
gpCurrentGroup dq 0
gpCurrentSubGroup dq 0
gpCurrentVertex dq 0
gpCurrentNormal dq 0
gpCurrentTextureVector dq 0
gpCurrentFace dq 0
gpCurrentMtlLib dq 0
...
gnTotalMaterials dd 0
gnTotalTextureNames dd 0

gnUniqueMaterials dd 0
gnUniqueTextureNames dd 0

gnArraySizeMaterials dq 0
gnArraySizeTextureNames dd 0

gpDataMaterials dq 0
gpDataTextureNames dq 0
...
;Material UBO
gpMaterialUBO dq 0
gpMaterialUBOMem dq 0
gpMaterialUBOMap dq 0
gnMaterialUBOSize dq 0

;Descriptor sets
ghVkDescriptorSetLayout dq 0
ghVkDescriptorPool dq 0
ghVkDescriptorSet dq 0
