...
; Material descriptor structures
align 10h
descSetLayoutInfo_sType dd 20h ;VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO = 32
descSetLayoutInfo_dummy0 dd 0
descSetLayoutInfo_pNext dq 0
descSetLayoutInfo_flags dd 0
descSetLayoutInfo_bindingCount dd 1
descSetLayoutInfo_pBindings dq offset descSetLayoutBinding_binding

; VkDescriptorSetLayoutBinding
align 10h
descSetLayoutBinding_binding dd 0
descSetLayoutBinding_descriptorType dd 6 ;VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER
descSetLayoutBinding_descriptorCount dd 1
descSetLayoutBinding_stageFlags dd 1 ; VK_SHADER_STAGE_VERTEX_BIT
descSetLayoutBinding_pImmutableSamplers dq 0

; VkDescriptorPoolSize
align 10h
descPoolSize_type dd 6 ;VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER
descPoolSize_descriptorCount dd 1

; VkDescriptorPoolCreateInfo
align 10h
descPoolInfo_sType dd 21h ;VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO = 33
descPoolInfo_dummy0 dd 0
descPoolInfo_pNext dq 0
descPoolInfo_flags dd 0
descPoolInfo_maxSets dd 1
descPoolInfo_poolSizeCount dd 1
descPoolInfo_pPoolSizes dq offset descPoolSize_type

; VkDescriptorSetAllocateInfo
align 10h
descSetAllocInfo_sType dd 22h ; VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO = 34
descSetAllocInfo_dummy0 dd 0
descSetAllocInfo_pNext dq 0
descSetAllocInfo_descriptorPool dq 0
descSetAllocInfo_descriptorSetCount dd 1
descSetAllocInfo_pSetLayouts dq 0

; VkDescriptorBufferInfo
align 10h
descBufferInfo_buffer dq 0
descBufferInfo_offset dq 0
descBufferInfo_range dq 0

; VkWriteDescriptorSet
align 10h
writeDescSet_sType dd 23h ; VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET = 35
writeDescSet_dummy0 dd 0
writeDescSet_pNext dq 0
writeDescSet_dstSet dq 0
writeDescSet_dstBinding dd 0
writeDescSet_dstArrayElement dd 0
writeDescSet_descriptorCount dd 1
writeDescSet_descriptorType dd 6 ; VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER
writeDescSet_pImageInfo dq 0
writeDescSet_pBufferInfo dq offset descBufferInfo_buffer
writeDescSet_pTexelBufferView dq 0
