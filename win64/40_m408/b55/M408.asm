...
include Obj\13_BuildCombinedVertices.asm
include Obj\20_ParseVertices.asm
include Obj\21_ParseNormals.asm
include Obj\22_ParseTextureCoords.asm
include Obj\30_ParseMtlFile.asm
include Obj\31_CountMtlEntities.asm
include Obj\40_AllocMaterials.asm
include Obj\41_AllocTextures.asm
include Obj\50_ParseMaterials.asm
include Obj\51_ParseTextures.asm
