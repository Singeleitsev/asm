...
;5. Align allocation size to the required alignment
...
;6. Set allocation size from requirements
mov depthAllocInfo_allocationSize,rax

;7. Allocate the Device Memory
...
;8. Bind the memory to the image
