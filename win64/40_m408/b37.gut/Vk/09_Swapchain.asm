...
;2. Create Swapchain
LOG_TEXT szVkCreateSwapchainKHR
...
LOG_TEXT szVkGetSwapchainImagesKHR
mov rcx,ghVkLogicalDevice
...
mov colorViewInfo_format,eax
mov colorViewInfo_subresourceRange_aspectMask,1 ;VK_IMAGE_ASPECT_COLOR_BIT
...
mov colorViewInfo_image,rax

mov rcx,ghVkLogicalDevice
lea rdx,colorViewInfo_sType
xor r8,r8 ;pAllocator
mov r9,pViews
...
LOG_TEXT szVkDestroySwapchainKHR
mov rcx,ghVkLogicalDevice
mov rdx,ghVkSwapchain
xor r8,r8
