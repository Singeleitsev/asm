...
;In0: rcx = Shift of Address for the First Affected Coordinate. Address = [v4D]+rcx
;In1: rdx = Shift of Address for the Second Affected Coordinate. Address = [v4D]+rdx
;In2: r8 = Angle of Rotation, Degrees
;Out:  Filled Array of Affected Coordinates, v3D
