;02_0_checkValidationLayerSupport.asm
...
xor rax,rax ;Set the Counter
lea rsi,gpValidationLayer0 ;Load the first Pointer
@@:
cmp qword ptr[rsi],0 ;Check if it is a nullptr
je @f ;If it is a nullptr then the Array is over
inc eax ;Increase the Counter
add rsi,8 ;Next Pointer
jmp @b
@@:
mov nValidationLayersCount,eax ;NumberOfLayers = Counter
