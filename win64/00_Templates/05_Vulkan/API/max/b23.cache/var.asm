...
;DeviceExtensions
dwDeviceExtensionsCount dd 0
gpDeviceExtensionProperties dq 0

;Dump
ghDevExtDumpFile dq 0 
...
;Pipeline Cache
ghVkPipelineCache dq 0
dwPipelineCacheSize dq 0
ghVkPipelineCacheData dq 0
ghPipelineCacheFile dq 0
