...
createInfo_enabledLayerCount dd 0 ;Dynamic
createInfo_dummy2 dd 0
createInfo_ppEnabledLayerNames dq 0 ;offset ppEnabledLayerNames (Dynamic)
createInfo_enabledExtensionCount dd 0 ;Dynamic
createInfo_dummy3 dd 0
createInfo_ppEnabledExtensionNames dq 0 ;offset ppEnabledExtensionNames (Dynamic)
...
deviceInfo_enabledExtensionCount dd 0 ;Dynamic
deviceInfo_dummy2 dd 0
deviceInfo_ppEnabledExtensionNames dq 0 ;dq offset ppDeviceExtensions (Dynamic)
...
align 10h
pipelineCacheInfo_sType dd 11h ;VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO = 17
pipelineCacheInfo_dummy0 dd 0
pipelineCacheInfo_pNext dq 0
pipelineCacheInfo_flags dd 0
pipelineCacheInfo_dummy1 dd 0
pipelineCacheInfo_initialDataSize dq 0
pipelineCacheInfo_pInitialData dq 0
...
inputAssembly_topology dd 5 ;VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN
...
align 10h
;clearValue_red dd 0
;clearValue_green dd 3f800000h ;1.0f
;clearValue_blue dd 0
;zlearValue_a dd 3f800000h ;1.0f
