...
extern vkEnumerateDeviceExtensionProperties:proc
...
;Pipeline Cache
extern vkCreatePipelineCache:proc
extern vkDestroyPipelineCache:proc
extern vkGetPipelineCacheData:proc
extern vkMergePipelineCaches:proc
;CommandPool
