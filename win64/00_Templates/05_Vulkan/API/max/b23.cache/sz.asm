...
szLogWmClose db 0Dh,0Ah,"WM_CLOSE received",0Dh,0Ah,0Dh,0Ah,0
...
;Instance Layers
szVkEnumerateInstanceLayerProperties db "vkEnumerateInstanceLayerProperties",0
szErrNoInstanceLayers db ". No Instance Layers found.",0

;Instance Layers Dump
...
;Instance Extensions
szVkEnumerateInstanceExtensionProperties db "vkEnumerateInstanceExtensionProperties",0
szErrNoInstanceExtensions db ". No Instance Extensions found.",0

;Instance Extensions Dump
...
szInstExtDebugUtils db "VK_EXT_debug_utils",0
szInstExtKhrSurface db "VK_KHR_surface",0
szInstExtKhrWin32Surface db "VK_KHR_win32_surface",0
...
szVkGetInstanceProcAddr db "vkGetInstanceProcAddr",0
...
szVkGetPhysicalDeviceProperties db "vkGetPhysicalDeviceProperties: ",0
...
;Device Extensions
szVkEnumerateDeviceExtensionProperties db "vkEnumerateDeviceExtensionProperties",0
szErrNoDeviceExtensions db ". No Device Extensions found.",0

;Device Extension Names
szDevExtSwapchain db "VK_KHR_swapchain",0

;Device Extensions Dump
szDevExtDumpFileName db "VulkanDevExtDump.txt",0
szDevExtDumpFileHeader db "Available Vulkan Device Extensions:",0
szDevExtHeader db 13,10,13,10,"Device Extension ",0
...
szLogQueueFamilySuccess db "Queue Family Selected Successfully",0Dh,0Ah,0
...
;Pipeline Cache
szVkCreatePipelineCache db "vkCreatePipelineCache",0
szVkGetPipelineCacheData db "vkGetPipelineCacheData",0
szPipelineCacheFileName db "pipeline.cache",0
...
;Semaphores
szVkCreateImageAvailable db "vkCreateSemaphoreImageAvailable",0
