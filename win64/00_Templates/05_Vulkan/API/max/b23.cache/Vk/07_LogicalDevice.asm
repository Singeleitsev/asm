...
;1. Determine if we need one or two VkDeviceQueueCreateInfo structures
...
;2. Get Graphics Queue Handle
LOG_TEXT szVkGetGraphicsQueue
...
;3. Get Present Queue Handle
LOG_TEXT szVkGetPresentQueue
mov rcx,ghVkLogicalDevice
xor rdx,rdx
