...
;Check if the Devise is Discrete
cmp gnDeviceType,2
jne lbl_checkDebugUtilsExt_End

mov eax,dwInstanceExtensionsCount
test eax,eax
jz lbl_checkDebugUtilsExt_End

LOG_TEXT szInstExtDebugUtils
...
lea rdx,szInstExtDebugUtils ;"VK_EXT_debug_utils",0
mov rdi,rsi
call lstrcmpA
test eax,eax
