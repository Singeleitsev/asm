...
next_device:
;1. Compute base score from device type (offset 10h)
mov eax,dword ptr [r15 + 10h]
mov gnDeviceType,eax ;For VK_LAYER_KHRONOS_validation
xor ebx,ebx ;score
...
;3. Vendor bonus – e.g., NVIDIA = 0x10DE
