...
LOG_TEXT szVkCreateSemaphoreImageAvailable
...
LOG_TEXT szVkCreateSemaphoreRenderFinished
mov rcx,ghVkLogicalDevice
lea rdx,semaphoreInfo_sType
xor r8,r8
...
cmp ghVkSemaphoreRenderFinished,0
je @f
LOG_TEXT szVkDestroySemaphoreRenderFinished
mov rcx,ghVkLogicalDevice
...
cmp ghVkSemaphoreImageAvailable,0
je @f
LOG_TEXT szVkDestroySemaphoreImageAvailable
mov rcx,ghVkLogicalDevice
