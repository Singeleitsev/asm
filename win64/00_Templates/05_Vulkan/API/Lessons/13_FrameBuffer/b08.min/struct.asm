...
createInfo_enabledLayerCount dd 0 ;1 if Debuuger needed
createInfo_dummy2 dd 0
createInfo_ppEnabledLayerNames dq 0 ;offset ppEnabledLayers if Debuuger needed
createInfo_enabledExtensionCount dd 2 ;3 if Debuuger needed
