...
shaderStageVert_pName dq offset szVertEntryPoint
...
shaderStageFrag_pName dq offset szFragEntryPoint
...
align 10h
pipelineInfo_sType dd 1Eh ; VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO = 30
...
;Shaders
include SPIR-V\vertex.asm
include SPIR-V\fragment.asm

;Graphics Pipeline
szVertEntryPoint db "main",0
szFragEntryPoint db "main",0
...
include 08_PipelineLayout\00_CreatePipelineLayoutProc.asm
include 08_PipelineLayout\01_DestroyPipelineLayoutProc.asm

include 09_Shaders\00_CreateShaderModulesProc.asm
include 09_Shaders\01_DestroyShaderModulesProc.asm

include 10_GraphicsPipeline\00_CreateGraphicsPipelineProc.asm
include 10_GraphicsPipeline\01_DestroyGraphicsPipelineProc.asm
