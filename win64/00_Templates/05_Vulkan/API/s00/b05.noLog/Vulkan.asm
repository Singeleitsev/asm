...
wcx_hbrBackground dq 5 ;(HBRUSH)(COLOR_WINDOW+0)
...
szLogInit db "=== Application Started ===", 0
szCRLF db 13,10, 0
szHexPrefix db "0x", 0
szLogEnterWinMain db "Entering WinMain", 0
szLogRegisterClass db "Registering window class...", 0
szLogRegisterClassSuccess db "Window class registered OK", 0
szLogCreateWindow db "Creating window...", 0
szLogCreateWindowSuccess db "Window created OK", 0
szLogWindowUpdated db "Window Updated", 0
szLogEnterMessageLoop db "Entering message loop", 0
szLogDrawScene db "DrawScene called", 0
szLogWmClose db "WM_CLOSE received", 0
szLogWmDestroy db "WM_DESTROY received", 0
szLogExitProcess db "Exiting process", 0
