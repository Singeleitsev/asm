...
;VkPushConstantRange
;align 10h
;pushConstantRange_stageFlags dd 1 ;VK_SHADER_STAGE_VERTEX_BIT
;pushConstantRange_offset dd 0
;pushConstantRange_size dd 64 ;sizeof(mat4) = 64 bytes
...
;pipelineLayoutInfo_pPushConstantRanges dq offset pushConstantRange_stageFlags
