...
;02_Validation - doesn't work with my Intel(R) Iris(R) Xe Graphics
...
include Vk\121_DestroyFrameBuffers.asm
;14_recCmd
include Vk\130_RecordCommandBuffers.asm
;15_Render
include Vk\140_DrawScene.asm
