...
jz lbl_choosePresentMode_VkError
...
xor rax,rax
mov eax,presentModesCount
shl rax,2 ;sizeof VkPresentModeKHR =  4 
mov r8,rax
call HeapAlloc
test rax,rax
jz lbl_choosePresentMode_WinError
...
;4. Phoose present mode – prefer MAILBOX (1),else FIFO (0)
