...
align 10h
deviceProp_apiVersion dd 0
deviceProp_driverVersion dd 0
deviceProp_vendorID dd 0
deviceProp_deviceID dd 0
deviceProp_deviceType dd 0
deviceProp_deviceName db 100h dup (0) ;256 bytes
deviceProp_pipelineCacheUUID db 10h dup (0) ;16 bytes
deviceProp_dummy0 dd 0
deviceProp_limits db 1F8h dup (0) ;504 bytes
deviceProp_sparseProperties db 14h dup (0) ;20 bytes
deviceProp_dummy1 dd 0
...
szLogGetPhysicalDeviceProperties db "GetPhysicalDeviceProperties: ",0
