...
lblWinMainLoop:
	mov eax,[hDC]
	or eax,eax
	jz lblWinMainProceedMessage
	push hDC
	push hWnd
	call ReleaseDC
	or eax,eax
	jnz lblWinMainProceedMessage
	push MB_OK or MB_ICONINFORMATION
	push offset SDE
	push offset RDC
	push L 0
...
lblWinMainProceedMessage:
	mov eax,hWnd
	or  eax,eax
	jz  lblWinMainSwapBuffers
	push hWnd
	call DestroyWindow
	or  eax,eax
	jnz  lblWinMainSwapBuffers
	push MB_OK or MB_ICONINFORMATION
	push offset SDE
	push offset CNR
	push L 0
...
lblWinMainLoop:
	mov ax,fullscreen
	or ax,ax
	jz  lblWinMainCheckKeys
	push L 0 
	call ShowCursor
	mov eax,WS_EX_APPWINDOW
	mov ebx,WS_POPUP
	jmp lblWinMainProceedMessage
lblWinMainCheckKeys:
