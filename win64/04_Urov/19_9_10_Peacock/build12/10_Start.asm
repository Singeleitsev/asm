...
;Standard Libraries
	...
	includelib C:\bin\dev\ml64\VS2017\lib\winmm.lib
;Custom Includes
...
;Sound files
	playFileCreate db 'resource\create.wav',0
	playFilePaint db 'resource\paint.wav',0
	playFileDestroy db 'resource\destroy.wav',0
;Captions and Labels
	szClassName db 'Приложение Win64',0
	szTitleName db 'Приложение Win64 на ассемблере',0
...
;Информации о версии Windows (Приложение 11)
	sub rsp,20h
	lea rcx,osvi
	call GetVersionExA
	;add rsp,20h
