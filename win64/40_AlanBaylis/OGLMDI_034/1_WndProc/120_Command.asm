...
jge lbl_WndProc_DefFrameProc

mov rcx,g_hMDIClient
mov rdx,229h ;WM_MDIGETACTIVE
xor r8,r8
xor r9,r9
Call SendMessageA ;<- Send
cmp rax,0
je lbl_WndProc_End
...
mov rcx,CHILD_TYPE_TOP
call CreateChild
jmp lbl_WndProc_Return0

lbl_WndProc_Command_NewFront:
mov rcx,CHILD_TYPE_FRONT
call CreateChild
jmp lbl_WndProc_Return0

lbl_WndProc_Command_NewLeft:
mov rcx,CHILD_TYPE_LEFT
call CreateChild
jmp lbl_WndProc_Return0

lbl_WndProc_Command_New3D:
mov rcx,CHILD_TYPE_3D
call CreateChild
jmp lbl_WndProc_Return0
