...
GetWindowLongA PROTO :QWORD,:QWORD
...
glColor4f PROTO :REAL4,:REAL4,:REAL4,:REAL4
...
glTexCoord2f PROTO :REAL4,:REAL4
glTexEnvf PROTO :QWORD,:QWORD,:REAL4
glTexImage2D PROTO :QWORD,:QWORD,:QWORD,:QWORD,:QWORD,:QWORD,:QWORD,:QWORD,:QWORD
glTexParameterf PROTO :QWORD,:QWORD,:REAL4
...
gluSphere PROTO :QWORD,:REAL8,:QWORD,:QWORD
...
;mcs MDICREATESTRUCT64 <> ;Method 2
;csa CREATESTRUCT64 <> ;Method 3
msg MSG64 <>
