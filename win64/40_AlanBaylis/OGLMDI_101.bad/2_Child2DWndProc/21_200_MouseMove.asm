...
mov r10d,dword ptr[rsi+18h] ;left
mov r11d,dword ptr[rsi+1Ch] ;top
mov r12d,dword ptr[rsi+20h] ;right
mov r13d,dword ptr[rsi+24h] ;bottom
mov r14b,byte ptr[rsi+28h] ;iType

mov rcx,hWnd
lea rdx,Rect2D
call GetClientRect
lea rsi,Rect2D
mov r10d,dword ptr[rsi] ;left
mov r11d,dword ptr[rsi+4] ;top
mov r12d,dword ptr[rsi+8] ;right
mov r13d,dword ptr[rsi+0Ch] ;bottom
...
lea rdi,Rect2D
cmp r8d,dword ptr[rdi] ;MouseX < WindowRect.left
jle lbl_Child2D_MouseRestoreX
cmp r8d,dword ptr[rdi+8] ;MouseX > WindowRect.right
...
lea rdi,Rect2D
cmp r9d,dword ptr[rdi+4] ;MouseY < WindowRect.top
jle lbl_Child2D_MouseRestoreY
cmp r9d,dword ptr[rdi+0Ch] ;MouseY > WindowRect.bottom
