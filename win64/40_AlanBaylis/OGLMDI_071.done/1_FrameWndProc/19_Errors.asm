...
lbl_GetMenu_Err:
lea rdx,szGetMenu_Err ;GetMenu returned 0
jmp lbl_FrameWndProc_ShowErrorMessage
...
lbl_Accelerator_Err:
lea rdx,szAccelerator_Err ;Accelerator creation failed
jmp lbl_FrameWndProc_ShowErrorMessage
...
lbl_CreateChild_NotMDIChild:
lea rdx,szCreateChild_NotMDIChild ;The child is not recognized as MDI child
jmp lbl_FrameWndProc_ShowErrorMessage
...
lbl_FrameWndProc_ShowErrorMessage:
xor rcx,rcx
lea r8,szWndProc
