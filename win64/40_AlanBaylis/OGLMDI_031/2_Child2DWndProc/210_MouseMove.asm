...
mov r10d,dword ptr[rsi+18h] ;Keep WindowRect.left in r10d, not in Memory
mov r11d,dword ptr[rsi+1Ch] ;Keep WindowRect.top in r11d, not in Memory
mov r12d,dword ptr[rsi+20h] ;Keep WindowRect.right in r12d, not in Memory
mov r13d,dword ptr[rsi+24h] ;Keep WindowRect.bottom in r13d, not in Memory
...
mov eax,r8d
sub eax,g_iMouseLastY2
mov g_iMouseDeltaY2,eax
;g_iMouseDeltaX2 = MouseX - g_iMouseLastX2
mov ebx,r9d
sub ebx,g_iMouseLastX2
mov g_iMouseDeltaX2,ebx
...
xor eax,eax
sub eax,r9d ;Try to get negative this way
