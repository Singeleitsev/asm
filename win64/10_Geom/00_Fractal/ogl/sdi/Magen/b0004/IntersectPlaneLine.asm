...
;IF (imm8[4] = 1) THEN Temp1[31:0] = DEST[31:0] * SRC[31:0] ELSE Temp1[31:0] = +0.0
;IF (imm8[5] = 1) THEN Temp1[63:32] = DEST[63:32] * SRC[63:32] ELSE Temp1[63:32] = +0.0
;IF (imm8[6] = 1) THEN Temp1[95:64] = DEST[95:64] * SRC[95:64] ELSE Temp1[95:64] = +0.0
;IF (imm8[7] = 1) THEN Temp1[127:96] = DEST[127:96] * SRC[127:96] ELSE Temp1[127:96] = +0.0
;Temp2[31:0] = Temp1[31:0] + Temp1[63:32]
;Temp3[31:0] = Temp1[95:64] + Temp1[127:96]
;Temp4[31:0] = Temp2[31:0] + Temp3[31:0]
;IF (imm8[0] = 1) THEN DEST[31:0] = Temp4[31:0] ELSE DEST[31:0] = +0.0
;IF (imm8[1] = 1) THEN DEST[63:32] = Temp4[31:0] ELSE DEST[63:32] = +0.0
;IF (imm8[2] = 1) THEN DEST[95:64] = Temp4[31:0] ELSE DEST[95:64] = +0.0
;IF (imm8[3] = 1) THEN DEST[127:96] = Temp4[31:0] ELSE DEST[127:96] = +0.0

;imm8[4] = 1 THEN Temp1[31:0] = xN * xV
;imm8[5] = 1 THEN Temp1[63:32] = yN * yV
;imm8[6] = 1 THEN Temp1[95:64] = zN * zV
;imm8[7] = 0 THEN Temp1[127:96] = +0.0
;Temp2[31:0] = xN * xV + yN * yV
;Temp3[31:0] = zN * zV
;Temp4[31:0] = xN * xV + yN * yV + zN * zV
;imm8[0] = 1 THEN DEST[31:0] = Temp4[31:0]
;imm8[1] = 0 THEN DEST[63:32] = +0.0
;imm8[2] = 0 THEN DEST[95:64] = +0.0
;imm8[3] = 0 THEN DEST[127:96] = +0.0

;Auxiliary Distance - Dot Product
;dist1 = xN*xV + yN*yV + zN*zV
;movups xmm4,xword [V] ;xV,yV,zV,tV
dpps xmm4,xword [N],01110001b ;xmm4 = dist1,dist1,dist1,dist1
...
dpps xmm6,xword [N],01110001b ;xmm6 = dist2,dist2,dist2,dist2
