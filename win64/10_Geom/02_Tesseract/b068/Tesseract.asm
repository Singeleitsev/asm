...
;Pointers depending on 256 or 512-bits registers
pLoad4D dq ?
pRot4D_One dq ?
pR4toR3 dq ?
...
;ViewPorts Positions
wView3D dd 400 ;= min(wScreen/2,hScreen)
hView3D dd 400 ;= wView3D
xView3D dd 0
yView3D dd 100 ;=(hScreen-hView3D)/2

wViewXY dd 200 ;= min((wScreen-wView3D)/2,hScreen/3)
hViewXY dd 200 ;= wViewXY
xViewXY dd 400 ;= wView3D
yViewXY dd 0 ;=(hScreen-3*hViewXY)/2

wViewXZ dd 200 ;= wViewXY
hViewXZ dd 200 ;= hViewXY
xViewXZ dd 400 ;= xViewXY
yViewXZ dd 200 ;= yViewXY+hViewXY

wViewXW dd 200 ;= wViewXY
hViewXW dd 200 ;= hViewXY
xViewXW dd 400 ;= xViewXY
yViewXW dd 400 ;= yViewXZ + hViewXY

wViewWY dd 200 ;= wViewXY
hViewWY dd 200 ;= hViewXY
xViewWY dd 600 ;= wView3D + wViewXY
yViewWY dd 0 ;= yViewXY

wViewYZ dd 200 ;= wViewXY
hViewYZ dd 200 ;= hViewXY
xViewYZ dd 600 ;= xViewWY
yViewYZ dd 200 ;= yViewXZ

wViewZW dd 200 ;= wViewXY
hViewZW dd 200 ;= hViewXY
xViewZW dd 600 ;= xViewWY
yViewZW dd 400 ;= yViewXW
...
vec_x_R4_to_R3 dd 0.5
vec_y_R4_to_R3 dd 0.5
vec_z_R4_to_R3 dd 0.5
...
include 03_Scene\SetCamera3D.asm
include 03_Scene\DrawView3D.asm
;include 03_Scene\SetCameraXY.asm
include 03_Scene\DrawViewXY.asm
;include 03_Scene\SetCameraXZ.asm
include 03_Scene\DrawViewXZ.asm
;include 03_Scene\SetCameraXW.asm
include 03_Scene\DrawViewXW.asm
;include 03_Scene\SetCameraWY.asm
include 03_Scene\DrawViewWY.asm
;include 03_Scene\SetCameraYZ.asm
include 03_Scene\DrawViewYZ.asm
;include 03_Scene\SetCameraZW.asm
include 03_Scene\DrawViewZW.asm
include 04_Object\TesseractDraw.asm
include 03_Scene\KillGLWindow.asm
include 04_Object\Load4D.asm
include 04_Object\Rot4D_All.asm
include 04_Object\Rot4D_One_256.asm
;include 04_Object\Rot4D_One_512.asm
include 04_Object\R4toR3_256.asm
;include 04_Object\R4toR3_512.asm
