...
;From the Front Buffer (v3D)
;to the Back Buffer (v4D)
lea rsi,v3D ;Current Coordinates
lea rdi,v4D ;Storage
...
xor rcx,rcx ;[x0] = [v4D]+0
mov rdx,40h ;[y0] = [v4D]+40h
...
mov rcx,80h ;[z0] = [v4D]+80h
mov rdx,0C0h ;[w0] = [v4D]+0C0h
