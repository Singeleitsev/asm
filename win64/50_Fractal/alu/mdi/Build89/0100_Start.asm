...
;Standard Libraries
        includelib C:\bin\dev\ml64\VS2019\lib\user32.lib
        includelib C:\bin\dev\ml64\VS2019\lib\kernel32.lib
        includelib C:\bin\dev\ml64\VS2019\lib\gdi32.lib
;Custom Includes
...
;SieveWndProc
        include 05_Sieve\0500_Sieve.asm
;GasketWndProc
        include 06_Gasket\0600_Gasket.asm
;NgonWndProc
        include 07_Ngon\0700_Ngon.asm
;TreeWndProc
        include 08_Tree\0800_Tree.asm
