...
;Re-Fill the wndclass Structure
 m64addr wndclass.lpfnWndProc,ChNPPWndProc
 mov wndclass.cbWndExtra,8 ;sizeof (HANDLE)
 Call1 GetStockObject,0 ;WHITE_BRUSH
 mov wndclass.hbrBackground,rax
 m64addr wndclass.lpszClassName,szChNPPClass
;Register the ChNPP Child Window Class
 sub rsp,20h
 lea rcx,wndclass
 call RegisterClassExA
 add rsp,20h
...
;Re-Fill the wndclass Structure
 m64addr wndclass.lpfnWndProc,RBMKWndProc
 Call1 GetStockObject,4 ;BLACK_BRUSH
 mov wndclass.hbrBackground,rax
 m64addr wndclass.lpszClassName,szRBMKClass
;Register the RBMK Child Window Class
 sub rsp,20h
 lea rcx,wndclass
 call RegisterClassExA
 add rsp,20h
...
lblLoadMenu:
 ...
 mov g_hMenuInit,rax
 Call2 LoadMenuA,g_hInst,MdiMenuChNPP
 mov g_hMenuChNPP,rax
 Call2 LoadMenuA,g_hInst,MdiMenuRBMK
 mov g_hMenuRBMK,rax

 Call2 GetSubMenu,g_hMenuInit,INIT_MENU_POS ;Position of SubMenu in MenuInit = 0
 mov g_hMenuWindowInit,rax
 Call2 GetSubMenu,g_hMenuChNPP,ChNPP_MENU_POS ;Position of SubMenu in MenuChNPP = 2
 mov g_hMenuWindowChNPP,rax
 Call2 GetSubMenu,g_hMenuRBMK,RBMK_MENU_POS ;Position of SubMenu in MenuRBMK = 1
 mov g_hMenuWindowRBMK,rax
...
CleanUp:
 Call1 DestroyMenu,g_hMenuChNPP
 Call1 DestroyMenu,g_hMenuRBMK
