...
hwndStatusBar dq 0
idStatusBar dq 0
xStatusParts dd 100,200,300,450,600,750,1000,-1 ;Divide Status Bar by 8 parts
...
include 24_AboutProc.asm
include 25_CloseProc.asm
include 30_InitializeGLProc.asm
include 31_ResetSceneProc.asm
include 40_DrawGLSceneProc.asm
;include 41_CheckKeys.asm
;include 42_CheckValues.asm
;include 43_RefreshStatus.asm
;include 44_SetView.asm
include 45_DrawAxesProc.asm
include 46_DrawObjectProc.asm
include 47_DrawCapProc.asm
