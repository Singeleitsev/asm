...
glScalef PROTO :XMMWORD,:XMMWORD,:XMMWORD
...
glNormal3f PROTO :XMMWORD,:XMMWORD,:XMMWORD
...
isSteady db 0 ;Prevents from recomputing coordinates
...
;Lights
light_position dd 0bf800000h,0bf800000h,3f800000h,0; -1.0, -1.0, 1.0, 0.0
;light_ambient As RGBA
light_diffuse dd 3a83126fh,3a83126fh,3a83126fh,3f800000h ;0.001,0.001,0.001,1.0
