...
;Camera Mode0 Movement 2D Vectors
dxCamX dd 0
dyCamX dd 0
dxCamY dd 0
dyCamY dd 0

;Camera Mode1 Movement 3D Vector
dxCam dd 0
dyCam dd 0
dzCam dd 0
...
include 34_CameraMove2DProc.asm
;include 35_CameraMode1.asm
include 36_CameraMove3DProc.asm
include 37_CheckDistanceProc.asm
;include 38_SetView.asm
