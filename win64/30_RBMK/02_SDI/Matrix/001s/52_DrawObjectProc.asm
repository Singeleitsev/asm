...
lea r8,light_ambient
Call glLightfv

mov rcx,4000h ;GL_LIGHT0
mov rdx,1203h ;GL_POSITION
lea r8,light_position
Call glLightfv

mov rcx,4001h ;GL_LIGHT1
Call glEnable

mov rcx,4001h ;GL_LIGHT1
mov rdx,1201h ;GL_DIFFUSE
lea r8,light_diffuse
Call glLightfv
